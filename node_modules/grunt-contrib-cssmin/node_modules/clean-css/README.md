...
Clean-css is a fast and efficient [Node.js](https://nodejs.org/) library for minifying CSS files.
...
```js
var CleanCSS = require('clean-css');
var source = '@import url(https://path/to/remote/styles);';
...
* [Gulp](https://gulpjs.com/): [gulp-minify-css](https://github.com/jonathanepollack/gulp-minify-css)
* [Gulp](https://gulpjs.com/): [using vinyl-map as a wrapper - courtesy of @sogko](https://github.com/jakubpawlowicz/clean-css/issues/342)
...
Additionally to mapping original CSS files, clean-css also supports input source maps, so minified styles can be mapped into their [Less](https://lesscss.org/) or [Sass](https://sass-lang.com/) sources directly.
