...
[UglifyJS documentation]: https://lisperator.net/uglifyjs/
...
Refer to the [UglifyJS SourceMap Documentation](https://lisperator.net/uglifyjs/codegen#source-map) for more information.
...
See [UglifyJS Codegen documentation](https://lisperator.net/uglifyjs/codegen) for more information.
...
See [UglifyJS global definitions documentation](https://lisperator.net/uglifyjs/compress#global-defs) for more information.
...
Task submitted by ["Cowboy" Ben Alman](https://benalman.com)
