...
- Results are binary equal to well known [zlib](https://www.zlib.net/) (now v1.2.8 ported).
...
- [browserify](https://browserify.org/) (via [browserify-zlib](https://github.com/devongovett/browserify-zlib))
...
Full docs - https://nodeca.github.io/pako/
...
- Vyacheslav Egorov ([@mraleph](https://github.com/mraleph)) for his awesome
  tutoruals about optimising JS code for v8, [IRHydra](https://mrale.ph/irhydra/)
