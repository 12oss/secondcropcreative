...
[API and internals documentation see my website](https://lisperator.net/uglifyjs/).
There's also an
[in-browser online demo](https://lisperator.net/uglifyjs/#demo) (for Firefox,
...
For example:
    ...
    uglifyjs /home/doe/work/foo/src/js/file1.js \
             ...
             --source-map-root https://foo.com/src \
             -p 5 -c -m
...
Check out
[original blog post](https://rreverser.com/using-mozilla-ast-with-uglifyjs/)
for details.
...
- `orig`: the "original source map", handy when you compress generated JS
  ...
  [codegen]: https://lisperator.net/uglifyjs/codegen
  [compressor]: https://lisperator.net/uglifyjs/compress
