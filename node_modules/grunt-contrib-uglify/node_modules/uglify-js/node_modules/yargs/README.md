...
```js
var argv = require('yargs')
  .epilogue('for more information, find our manual at https://example.com');
```
...
or clone this project on github:
    ...
    git clone https://github.com/bcoe/yargs.git
...
[Getopt::Casual](https://search.cpan.org/~photo/Getopt-Casual-0.13.1/Casual.pm).
