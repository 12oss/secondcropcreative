...
The [modern build](https://github.com/lodash/lodash/wiki/Build-Differences) of [lodash](https://lodash.com/) exported as [Node.js](https://nodejs.org/)/[io.js](https://iojs.org/) modules.
...
**Note:**<br>
Don’t assign values to the [special variable](https://nodejs.org/api/repl.html#repl_repl_features) `_` when in the REPL.<br>
 ...
 * Follows [semantic versioning](https://semver.org/) for releases
 * [Lazily evaluated](https://filimanjaro.com/blog/2014/introducing-lazy-evaluation/) chaining
 ...
 * [_.curry](https://lodash.com/docs#curry) & [_.curryRight](https://lodash.com/docs#curryRight) for creating [curried](https://hughfdjackson.com/javascript/why-curry-helps/) functions
 ...
 * [_.template](https://lodash.com/docs#template) supports [*“imports”*](https://lodash.com/docs#templateSettings-imports) options & [ES template delimiters](https://people.mozilla.org/~jorendorff/es6-draft.html#sec-template-literal-lexical-components)
