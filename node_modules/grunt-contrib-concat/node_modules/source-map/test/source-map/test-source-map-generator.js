...
define(function (require, exports, module) {
  ...
  exports['test the two additional parameters of applySourceMap'] = function (assert, util) {
    ...
    bundleMap.addMapping({
      ...
      source: 'https://www.example.com/baz.coffee'
    });
    bundleMap.setSourceContent(
      'https://www.example.com/baz.coffee',
      'baz coffee'
    );
    ...
    util.assertEqualMaps(assert, actualMap('https://foo.org/app/temp/temp_maps'), expectedMap([
      'https://foo.org/app/coffee/foo.coffee',
      'https://foo.org/bar.coffee',
      'https://www.example.com/baz.coffee'
    ]));
