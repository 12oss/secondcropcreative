...
define(function (require, exports, module) {
  ...
  exports['test join()'] = function (assert, util) {
    ...
    assert.equal(libUtil.join('https://foo.org/a//', ''), 'https://foo.org/a');
    assert.equal(libUtil.join('https://foo.org/a//', '.'), 'https://foo.org/a');
    assert.equal(libUtil.join('https://foo.org', ''), 'https://foo.org/');
    assert.equal(libUtil.join('https://foo.org', '.'), 'https://foo.org/');
    assert.equal(libUtil.join('https://foo.org/', ''), 'https://foo.org/');
    assert.equal(libUtil.join('https://foo.org/', '.'), 'https://foo.org/');
    assert.equal(libUtil.join('https://foo.org//', ''), 'https://foo.org/');
