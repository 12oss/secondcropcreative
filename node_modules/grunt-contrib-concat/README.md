...
See [configuring files for a task](https://gruntjs.com/configuring-tasks#files) for how to configure file globbing in Grunt.
...
[multitask]: https://gruntjs.com/creating-tasks#multi-tasks
