/*!
 * Lo-Dash v0.9.2 <https://lodash.com>
 * (c) 2012 John-David Dalton <https://allyoucanleet.com/>
 * Based on Underscore.js 1.4.2 <https://underscorejs.org>
...
;(function(window, undefined) {
   ...
   * https://people.mozilla.org/~jorendorff/es6-draft.html#sec-7.8.6
   */
   ...
   * https://msdn.microsoft.com/en-us/library/121hztk3(v=vs.94).aspx
   */
  try {
  ...
  function isEqual(a, b, stackA, stackB) {
    ...
    switch (className) {
      ...
      case regexpClass:
      case stringClass:
        // coerce regexes to strings (https://es5.github.com/#x15.10.6.4)
    ...
    // section 15.12.3, abstract operation `JO` (https://es5.github.com/#x15.12.3)
    stackA || (stackA = []);
    stackB || (stackB = []);
   ...
   * booleans and empty strings. See https://es5.github.com/#x15.1.2.5.
   *
   * @deprecated
   * @static
   * @memberOf _
   ...
   * `undefined` and other values. See https://es5.github.com/#x15.1.2.4.
   *
   * @deprecated
   * @static
   * @memberOf _
   ...
   * `range()` function. See https://docs.python.org/library/functions.html#range.
   *
   * @static
   * @memberOf _
   * @category Arrays
  ...
  function range(start, end, step) {
    ...
    // https://www.youtube.com/watch?v=XAqIpGU8ZZk#t=16m27s
    var index = -1,
   ...
   * See https://developer.chrome.com/trunk/extensions/sandboxingEval.html
   *
   * @static
   * @memberOf _
   * @category Utilities
