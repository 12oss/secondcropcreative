$(document).ready(function() {
  ...
  test("Strings: trim", function() {
    ...
    equals(_("https://foo/").trim("/"), "https://foo");
    equals(_("c:\\").trim('\\'), "c:");
  ...
  test("Strings: rtrim", function() {
    equals(_("https://foo/").rtrim("/"), "https://foo", 'clean trailing slash');
  ...
  test("Strings: sprintf", function() {
    ...
    // https://www.diveintojavascript.com/projects/sprintf-for-javascript
