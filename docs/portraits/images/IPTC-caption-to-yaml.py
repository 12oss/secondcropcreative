...
def get_iptc_caption(image_path):
    ...
    caption = result.stdout.split(":")[1].strip() if ":" in result.stdout else ""
    return caption
...
if __name__ == "__main__":
    ...
    directory_path = '/Users/harriedr_1/Documents/github/secondcropcreative/_gh_pages/portraits/images/2024/20240908-austin'
